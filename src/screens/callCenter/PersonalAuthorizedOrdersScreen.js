...
function PersonalAuthorizedOrdersScreen(props) {
                ...
                >
                  ...
                  <div className="user-orders-status-bar">
                    ...
                    {order.isAuthorized === true ? (
                      <div
                        className="user-orders-status-line"
                        style={{ width: '20.7%' }}
                      >
                        <div
                          style={{
                  ...
                  <div className="user-orders-status-bar-content">
                    ...
                    <div
                      className="user-orders-status-authorized-text"
                      style={{ marginLeft: '28rem' }}
                    >
                      Order Authorized
                    </div>
                    <div
                      className="user-orders-status-prepared-text"
                      style={{ marginLeft: '26.1rem' }}
                    >
                      Order Processed
                    </div>
                    <div
                      className="user-orders-status-delivery-text"
                      style={{ marginLeft: '25.7rem' }}
                    >
                      Order Out For Delivery
                    </div>
                    <div
                      className="user-orders-status-delivered-text"
                      style={{ marginLeft: '26.6rem' }}
                    >
                      Order Delivered
                    </div>
                  </div>
                  <div className="d-flex justify-content-between">
                    <div className="admin-order-items" style={{ width: '29%' }}>
...
export default PersonalAuthorizedOrdersScreen;
