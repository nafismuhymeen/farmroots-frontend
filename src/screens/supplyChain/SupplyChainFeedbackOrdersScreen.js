...
function SupplyChainFeedbackOrdersScreen(props) {
  ...
  }, [orderCompleteSuccess, deliveryGuy]);
    ...
    <div className="grid">
      ...
      <div className="main">
        <div className="d-flex">
          <SupplyChainSidebar value={"Feedback"}></SupplyChainSidebar>
...
export default SupplyChainFeedbackOrdersScreen;
