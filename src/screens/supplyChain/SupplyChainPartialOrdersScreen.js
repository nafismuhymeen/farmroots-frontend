...
import { processOrder, listSupplyChainOrders } from '../../actions/orderActions';
...
function SupplyChainPartialOrdersScreen(props) {
    ...
    return <div className="grid">
        ...
        <div className="main">
            <div className="d-flex">
                <SupplyChainSidebar value={"Partial"}></SupplyChainSidebar>
                <div className="admin-content" style={{paddingTop: "2rem"}}>
                    {loading ? <div></div> :
                    error ? <div>{error.message}</div> :
                    <>
                        <div className="admin-header">
                            <div className="admin-header-text">{`Partial Orders (${orders.length})`}</div>
                        </div>
                        <div className="admin-orders">
                            {orders.map(order => ( <div key={order._id} className="admin-orders-content-box" style={{width: "100%"}}>
                                <div className="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <Button onClick={() => confirmModalHandler(order._id)} style={{width: '21rem'}} className="user-orders-view-details-button">Process Order</Button>
                                    </div>
                                </div>
                                <div className="d-flex justify-content-between">
...
export default SupplyChainPartialOrdersScreen;