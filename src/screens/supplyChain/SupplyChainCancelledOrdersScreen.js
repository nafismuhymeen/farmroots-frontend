...
function SupplyChainCancelledOrdersScreen(props) {
  const [id, setId] = useState("");

  const orderComplete = useSelector((state) => state.orderComplete);
  const { success: orderCompleteSuccess } = orderComplete;
    ...
    <div className="grid">
        ...
        <Modal.Body>
          <div className="confirm-container">
            ...
            <div className="confirm-text">
              Do you really want to complete this order? This process cannot be
              undone.
            </div>
      ...
      <div className="main">
        <div className="d-flex">
          <SupplyChainSidebar value={"Cancelled"}></SupplyChainSidebar>
                      ...
                      <div className="d-flex justify-content-between">
                        <div className="d-flex">
                          ...
                          <div className="user-orders-info">
                            ...
                            {order.hasFeedback ? (
                              <div className="user-orders-info-data">Taken</div>
                            ) : (
                              <div className="user-orders-info-data">
                                Pending
                              </div>
...
export default SupplyChainCancelledOrdersScreen;
