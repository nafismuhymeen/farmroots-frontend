...
function GroceryScreen(props) {
  ...
  }, [wishlistAddSuccess, wishlistDeleteSuccess, userInfo]);
  ...
  const _onSelect = (option) => {
    props.history.push(
      `/grocery/category/${category}?sub-category=${option.label}`
    );
  };
  ...
  //
  // console.log("productsproducts",products,"=>","new arr=>",arr,arr2," asd=>",arr.concat(arr2));
        ...
        <Row className="margin-LR">
                ...
                <>
                  <div class="dropdown">
                    ...
                    >
                      ...
                      <FiChevronRight className="grocery-sidebar-dropdown-arrows dropdown-arrows"></FiChevronRight>
                    </button>
          ...
          <Col sm="9">
            ...
            <Row className="mb-3 mt-3">
              ...
              <Col sm="12" lg={{ size: 4 }}>
                <h1 className="grocery-search-sort-heading">All Products</h1>
              </Col>
