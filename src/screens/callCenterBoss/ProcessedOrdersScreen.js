...
function ProcessedOrdersScreen(props) {
    ...
    <div className="grid">
      ...
      <div className="main">
        <div className="d-flex">
          <CallCenterBossSidebar value={"Processed"}></CallCenterBossSidebar>
                  ...
                  {orders.map((order) => (
                    <div key={order._id} className="admin-orders-content-box">
                      <div className="d-flex justify-content-between">
                        ...
                        {/* <div>
                                        <Button onClick={() => openEditModal(order)} style={{width: '12rem'}} className="user-orders-view-details-button">Edit Order</Button>
                                    </div> */}
                      </div>
                      <div>
                        <div
...
export default ProcessedOrdersScreen;
